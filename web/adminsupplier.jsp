    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="add-book-container">
                <button class="add-btn" onclick="openModal('addBookModal')">Add supplier</button>
            </div>

            <!-- Search Bar -->
            <div class="search-container" style="margin-bottom: 15px;">
                <form action="${pageContext.request.contextPath}/adminsupplierlist" method="GET">
                    ...
                    <c:otherwise>
                        <c:forEach var="book" items="${booklist}">
                            <tr>
                                ...
                                <td>${book.status}</td>
                                <td>
                                    <button class="update-btn" onclick="openEditModal('${book.supplierId}', '${book.supplierName}', '${book.status}', '${book.description}')">Update</button>
                                </td>
                            </tr>
                        </c:forEach>
                    </c:otherwise>
            ...
            <div class="pagination">
                <c:if test="${pageNo > 1}">
                    <a href="${pageContext.request.contextPath}/adminsupplierlist?pageNo=${pageNo - 1}&nameOrId=${param.nameOrId}">Previous</a>
                </c:if>
                <a href="${pageContext.request.contextPath}/adminsupplierlist?pageNo=${pageNo}&nameOrId=${param.nameOrId}">${pageNo}</a>
                <c:if test="${pageNo < totalPages}">
                    <a href="${pageContext.request.contextPath}/adminsupplierlist?pageNo=${pageNo + 1}&nameOrId=${param.nameOrId}">Next</a>
                </c:if>
            </div>
            ...
            <div id="addBookModal" class="modal">
                <div class="modal-content">
                    ...
                    <h2>Add Supplier</h2>
                    <form action="${pageContext.request.contextPath}/adminaddsupplier" method="get">
                        <label for="bookName">Supplier Name:</label>
            ...
            <div id="editBookModal" class="modal">
                <div class="modal-content">
                    ...
                    <h2>Edit Supplier</h2>
                    <form action="${pageContext.request.contextPath}/adminupdatesupplier" method="get">
                        <input type="hidden" id="editBookId" name="bookId">

                        <label for="editBookName">Supplier Name:</label>
                        <input type="text" id="editBookName" name="bookName" required>

                        <label for="editBookDescription">Description:</label>
                        <textarea id="editBookDescription" name="bookDescription" rows="4" required></textarea>
